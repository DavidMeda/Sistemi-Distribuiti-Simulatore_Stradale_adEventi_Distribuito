...
public class RegolatoreCodaCorta extends ABS_Regolatore {

	public RegolatoreCodaCorta(RSU rsu, List<NetEdge> archiEntranti) {
		super(rsu, archiEntranti, 1);
	}
	...
	public double getCongestione(SemaforoCodaCorta semaforo) {

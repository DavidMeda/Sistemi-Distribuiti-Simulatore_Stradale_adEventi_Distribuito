...
public class RegolatoreCodaLunga extends ABS_Regolatore {

	public RegolatoreCodaLunga(RSU rsu, List<NetEdge> archiEntranti) {
		super(rsu, archiEntranti, 2);
	}
	...
	public double getCongestione(SemaforoCodaLunga semaforo) {

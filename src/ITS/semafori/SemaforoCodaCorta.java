...
import ITS.regolatoriSemafori.RegolatoreCodaCorta;
import network.CityGraph;
import network.NetEdge;
import util.Param;
import veicoli.Vehicle;

public class SemaforoCodaCorta extends ABS_Semaforo {
	...
	public SemaforoCodaCorta(Regolatore regolatore, NetEdge edge) {
	...
	public double setVerde() {
		...
		double gradoCongestione = ((double) ((RegolatoreCodaCorta) regolatore).getCongestione(this));

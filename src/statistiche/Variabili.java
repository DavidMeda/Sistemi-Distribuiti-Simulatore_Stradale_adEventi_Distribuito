...
public class Variabili implements Serializable {
	...
	private double sommaTempiAttesa = 0.0, distanzaCoperta = 0.0;
	...
	public double getSommaTempiAttesa() {
		return sommaTempiAttesa;
	}

	public double getNumeroDiAttraversamenti() {
		return veicoliperRSU;
	}

	public double getTempoMedioAttesa() {
		return sommaTempiAttesa / veicoliperRSU;
	}

	public double getDistanzaMediaCoperta() {
		return distanzaCoperta / veicoliperRSU;
	}
	...
	// public double getNumeroIndirizzamentiSuPercorsoMinimo(){return
	// numeroIndirizzamentiSuPercorsoMinimo;}
	// public double getIndirizzamentoPercorsoMinimo(){
	// System.out.println(this+"percosoMini: "+numeroIndirizzamentiSuPercorsoMinimo+"
	// percorsiTOT: "+numeroIndirizzamenti);
	...
	public void updateVeicoliRSU() {
		veicoliperRSU++;
	}

	public void numVeicoliTot(int num) {
		veicoliTot = num;
	}
	...
	public void updateDistanzaCoperta(double distanzaVeicoloSuArco) {
		distanzaCoperta = distanzaVeicoloSuArco;
	}

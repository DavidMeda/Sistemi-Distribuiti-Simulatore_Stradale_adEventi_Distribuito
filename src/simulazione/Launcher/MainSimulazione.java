...
public class MainSimulazione {
	...
	public void inputParam() {
		...
		String[] semafori = { "SEMAFORO CLASSICO", "SEMAFORO A CODA CORTA", "SEMAFORO A CODA LUNGA"};
		...
		do {
			...
			if (res == 0) {
				...
				if (semaforoScelto.getSelectedItem().equals("SEMAFORO CLASSICO")) Param.setSemaforo(0);
				else if (semaforoScelto.getSelectedItem().equals("SEMAFORO A CODA CORTA")) Param.setSemaforo(1);
				Param.setSemaforo(2);

...
public class RegolaDestinazioniSorgenti extends Regole {
	...
	/**
	 * Questa regola serve per settare quante sorgenti e quante destinazioni possono essere
	 * raggiunte dai veicoli
	 * 
	 * es: se numSorgenti=3 si scelgono 3 sorgenti a caso dal grafo e una di queste tre viene
	 * assegnata ai veicoli e numDestinazioni=0 viene scelta random dal grafo
	 * 
	 * 
	 */
	...
	public void applicaRegole(MainSimulazione simulazione, LinkedList<Vehicle> listaVeicoli) {
		...
		// System.out.println(this+": numero sorgenti = "+numeroSorgenti+" - numero destinazioni =
		// "+numeroDestinazioni);
		...
		for (int i = 0; i < numeroDestinazioni; i++) {
			...
			/*
			 * print* System.out.println(this+": aggiunto "+idNodoDestinazione+" alle destinazioni");
			 * /
			 **/
		...
		/*
		 * print* System.out.println(this+": destinazioni scelte = "+destinazioni); /
		 **/
		...
		/*
		 * print* System.out.println(this+": sorgenti scelte = "+sorgenti); /
		 **/
		...
		for (Vehicle auto : listaVeicoli) {
			...
			if (numeroDestinazioni == 0) {
				...
				/*
				 * print*
				 * System.out.println(this+": destinazioni infinite -- "+auto+" destinazione "+auto.
				 * getTargetNode()); /
				 **/
			}
			// destinazione random dalla lista destinazioni
				...
				auto.setTargetNode(destinazione);
				/*
				 * print* System.out.println(this+": "+auto+" destinazione "+auto.getTargetNode()); /
				 **/
			}
			...
			if (numeroSorgenti == 0) {
				...
				auto.setStartingNode(sorgente);
				/*
				 * print* System.out.println(this+": sorgenti infinite -- "+auto+" sorgente "+auto.
				 * getStartingNode()); /
				 **/
			}
			...
			// sorgente random tra le lista Sorgenti
				...
				auto.setStartingNode(sorgente);
				/*
				 * print* System.out.println(this+": "+auto+" sorgente "+auto.getStartingNode()); /
				 **/
			}

...
public enum Scenario {
	UNA_SORGENTE(new RegolaDestinazioniSorgenti(0, 1)), DUE_SORGENTI(new RegolaDestinazioniSorgenti(0, 2)),

	UNA_DESTINAZIONE(new RegolaDestinazioniSorgenti(1, 0)), DUE_DESTINAZIONI(new RegolaDestinazioniSorgenti(2, 0)),
